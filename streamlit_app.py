...
with tab2:
    ...
    st.write("""
    2. **Price vs. Duration**:
       - There is a noticeable positive correlation between flight duration and price. Generally, longer flights tend to be more expensive, but the relationship is not linear, indicating that other factors (e.g., the airline or number of stops) might also influence prices.
    """)
